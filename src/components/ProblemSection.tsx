        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            {[
              ...
              "While you're blending in with generic marketing, your competitors who embrace authenticity are stealing your market share.",
              "The painful truth: Your audience can smell the artificial from miles away. And they're running toward brands that feel real."
            ].map((text, index) => (
              <motion.p
                key={index}
